    ...
    <div>
      <div className="grid grid-cols-3 w-full gap-5">
          ...
          <div>
            ...
            <div className="text-gray-500 mt-3">
              <p>
                ...
                Obcaecati architecto voluptas velit perferendis voluptates!
                Perspiciatis laudantium voluptas recusandae aut, fugit atque
                sequi inventore harum exercitationem quaerat minus. Vero,
                sapiente tempore.
              </p>
            </div>
          </div>
        ...
        <div>
          ...
          <div className="bg-gray-100 p-3 text-center my-6">
            ...
            <Progress className="h-2 bg-zinc-400 mt-3" value={10} />
          </div>
          ...
          <div className="mb-10 space-y-5">
            ...
            <div className="flex justify-between">
              ...
              <div className="font-semibold">$1000 - $5000 USD</div>
            </div>
          </div>
          ...
          <div className="my-10">
            <div className="text-3xl font-semibold mb-4">Requried Skills</div>
            <div className="space-x-5">
              {["Frontend Developer"].map((item: string, i: number) => (
          ...
          <div className="my-10">
            <div className="text-3xl font-semibold mb-4">Requried Skills</div>
            <div className="space-x-5">
              {["Next", "React"].map((item: string, i: number) => (
      ...
      <div>
        ...
        <div className="text-gray-500">
          This job with several perks and benefits
        </div>
